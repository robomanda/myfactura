...
class Inventory:
    def __init__(self, top=None):
        ...
        self.product_key_entry.configure(font=medium_font, relief="flat", state="normal")
        ...
        self.tree.heading("product_id", text="IMI", anchor=W)
    ...
    def update_product(self, event=None):
        ...
        if len(self.tree.selection()) == 1:
            ...
            update_product_pg.product_name_entry.configure(state='normal')
            ...
            for entry in [update_product_pg.product_name_entry, update_product_pg.product_brand_entry, update_product_pg.product_size_entry, update_product_pg.product_color_entry]:
                entry.configure(font=medium_font, relief="flat", state="normal")
                update_product_pg.product_id_entry.configure(state="disabled")
            p_update.mainloop()
...
class AddProductDetails:
    def __init__(self, top=None):
        ...
        self.product_name_entry.configure(font=medium_font, relief="flat", state = NORMAL)
        ...
        #self.product_name_entry.configure(state=NORMAL)
...
class UpdateProductDetails:
    def __init__(self, top=None):
        ...
        self.product_name_entry.place(relx=0.075, rely=0.319, width=screen_ratio[0]*325, height=screen_ratio[1]*33)
        self.product_name_entry.configure(font=medium_font, relief="flat", validate="key")
        self.product_name_entry.bind("<Return>", lambda event: self.product_hsn_entry.focus())
        self.product_name_entry.bind("<Down>", lambda event: self.product_hsn_entry.focus())
        self.product_name_entry.bind("<Up>", lambda event: self.product_id_entry.focus())
    ...
    def update_product_details(self):
        ...
        try:
            ...
            cur.execute(f"UPDATE inventory SET product_id='{p_id}', product_name='{p_name}', product_hsn='{p_hsn}', product_brand='{p_brand}', product_size='{p_size}', \
